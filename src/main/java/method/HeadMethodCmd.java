...
public class HeadMethodCmd extends MethodCmd{

    public HeadMethodCmd(ResourceManager resourceManager, ResponseFactory responseFactory, ErrorResponseHandler errorHandler){
    ...
    public Response exec(Request request) throws RuntimeException{
        try {
            ...
            return this.responseFactory.getInstance(resource, OK, request.getProtocolVersion(),2);
        } catch (IOException e) {
